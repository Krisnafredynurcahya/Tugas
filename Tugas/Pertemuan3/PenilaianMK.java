...
public class PenilaianMK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ALOGARITMA PEMROGRAMAN 2");
        ...
        nim.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1855201023", "1855201034", "1855201041" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(huruf, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(34, 34, 34))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(NAMA)
                                    .addComponent(nim, 0, 140, Short.MAX_VALUE))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())))
        );
    ...
    private void nimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nimActionPerformed
        ...
        if (angka == 1855201023){
            NAMA.setText("Krisna Fredy");
        } else if (angka == 1855201034){
            NAMA.setText("Yusuf Khomaruddin");
        } else if (angka == 1855201041){
            NAMA.setText("Rehan Fahmi");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            int Hasil_Angka, Kehadiran, Tugas, UTS, UAS;
            ...
            Hasil_Angka = Kehadiran + Tugas + UTS + UAS;

            if (Hasil_Angka > 90 && Hasil_Angka <= 100) {
                angka.setText(String.valueOf(Hasil_Angka));
                huruf.setText("A");
            } else if (Hasil_Angka >= 85) {
                angka.setText(String.valueOf(Hasil_Angka));
                huruf.setText("B");
            } else if (Hasil_Angka >= 75) {
                angka.setText(String.valueOf(Hasil_Angka));
                huruf.setText("C");
            } else if (Hasil_Angka >= 65) {
                angka.setText(String.valueOf(Hasil_Angka));
                huruf.setText("D");
            } else if (Hasil_Angka <= 55) {
                angka.setText(String.valueOf(Hasil_Angka));
                huruf.setText("E");
            } else {
